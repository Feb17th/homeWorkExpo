...
interface DataLocationScreenProp {
  route: RouteProp<RootStackParamList, RootScreens.DATA_LOCATION>
}
  ...
  return (
    <View style={styles.container}>
      <View style={styles.containerContent}>
        ...
        >
          {i18n.t(LocalizationKey.DATALOCATION_DESCRIPTION)}:
        </Text>
        ...
        >
          {i18n.t(LocalizationKey.DATALOCATION_POSITION)}:
        </Text>
